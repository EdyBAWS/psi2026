...
export default function PreluareAutoHeader({
  ...
  return (
    <div
      className={`z-40 border bg-white/95 backdrop-blur-md transition-all duration-300 ${
        vehiculSelectat
          ? 'sticky top-0 mb-6 rounded-2xl border-indigo-100 px-5 py-4 shadow-md'
          : 'relative rounded-2xl border-slate-100 p-8 shadow-sm'
      }`}
    >
      {!vehiculSelectat ? (
